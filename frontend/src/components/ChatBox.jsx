    ...
    <div className="ChatBox">
      <div className="chat-header">
        <div className="left-side">
          <img
            src="https://firebasestorage.googleapis.com/v0/b/socialsphere-2023.appspot.com/o/mmirkovic99%2Fimages%2Fprofile%2Fmmirkovic99_1693515351090?alt=media&token=483be977-e7fc-4904-9db5-7d299e62145b"
            id="titleprofilePicture"
            alt=""
          />
          <div className="user-info">
            <div className="name">Miroslav Mirković</div>
            <div className="username">@mmirkovic99</div>
          </div>
        </div>
