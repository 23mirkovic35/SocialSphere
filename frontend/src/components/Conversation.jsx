...
export default function Conversation({
  ...
  useEffect(() => {
    if (lastMessage) {
      if (lastMessage.senderID === myUsername) {
        setIsMe(true);
      } else setIsMe(false);
    }
  }, [lastMessage]);
    ...
    >
      ...
      <div className="other">
        <div className="header">
          ...
          <div className="time">{formatTimeDifference(lastMessage.time)}</div>
        </div>
        {lastMessage.text && (
          <div>
            {isMe && (
              <div className="last-message">You: {lastMessage.text}</div>
            )}
            {!isMe && <div className="last-message">{lastMessage.text}</div>}
          </div>
        )}
        ...
        {lastMessage.videos && lastMessage.videos.length > 0 && (
          <div>
            {isMe && (
              <div className="last-message">
                <div>You:</div>
